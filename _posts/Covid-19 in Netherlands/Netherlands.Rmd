...
The figure \@ref(fig:testdot) shows the number of people tested and diagnosed for COVID-19 per one million people in each country. The Netherlands, represented by the red dots, has a lower number but a higher number of confirmed cases than other countries. If conditions permit, it is suggested that the government still needs to increase the number of virus tests.
...
```
The figure \@ref(fig:hosiptalcar) shows how governmental response has changed over time. 
...
- The basic knowledge about covid-19 and Netherlands is from @wikico and @2021CD-C.
